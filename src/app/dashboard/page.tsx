	...
	return (
		<div className="flex flex-col xl:flex-row gap-y-4 xl:gap-x-4">
			<div className="flex flex-col sm:flex-row gap-y-4 sm:gap-x-4 xl:w-2/3">
				<div className="h-auto w-full sm:w-1/2 flex flex-col shadow-md rounded-lg bg-white dark:bg-black bg-opacity-90 hover:cursor-pointer">
			...
			<div className="h-auto w-full xl:w-1/3 flex flex-col shadow-md rounded-lg bg-white dark:bg-black bg-opacity-90 hover:cursor-pointer">
				<div className="px-10 py-5">
